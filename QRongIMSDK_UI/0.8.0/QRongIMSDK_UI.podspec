...
Pod::Spec.new do |s|
  ...
  s.subspec 'IMKit' do |kit|
    ...
    kit.source_files = 'RongIMKit/*.{h,m,c}','RongIMKit/**/*.{h,m,c}'
  ...
  s.subspec 'Sticker' do |rs|
    ...
    rs.source_files = 'RongSticker/*.{h,m,c}','RongSticker/**/*.{h,m,c}'
    rs.dependency 'QRongIMSDK_UI/IMKit'
  end

  s.subspec 'Sight' do |st|
    st.source_files = 'RongSight/*.{h,m}','RongSight/**/*.{h,m}'
  ...
  s.subspec 'IFly' do |fly|
    ...
    fly.source_files = 'RongiFlyKit/*.{h,m}','RongiFlyKit/**/*.{h,m}'
  ...
  s.subspec 'ContactCard' do |cc|
    cc.source_files = 'RongContactCard/*.{h,m,c}','RongContactCard/**/*.{h,m,c}'
    cc.dependency 'QRongIMSDK_UI/IMKit'
  end

  s.subspec 'CallKit' do |ck|
    ck.source_files = 'RongCallKit/*.{h,m,mm}','RongCallKit/**/*.{h,m,mm}'
